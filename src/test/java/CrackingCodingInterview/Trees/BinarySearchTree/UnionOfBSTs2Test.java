 ...
 */
public class UnionOfBSTs2Test {

    UnionOfBSTs2 z = new UnionOfBSTs2();
    ...
    public void testGetUnionOFBSTS() throws Exception {
        BinarySearchNode union = z.getUnionOFBSTS(root, root1);
        Assert.assertEquals((int) (Integer) union.getData(), 9);
        Assert.assertEquals((int)(Integer)union.getLeft().getData() , 5);
        Assert.assertEquals((int)(Integer)union.getRight().getData() , 14);
        Assert.assertEquals((int)(Integer)union.getLeft().getLeft().getData() , 2);
        Assert.assertEquals((int)(Integer)union.getLeft().getLeft().getRight().getData() , 4);
        Assert.assertEquals((int)(Integer)union.getLeft().getRight().getData() , 7);
        Assert.assertEquals((int)(Integer)union.getLeft().getRight().getRight().getData() , 8);
    }
}