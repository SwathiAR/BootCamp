 ...
 */
public class ExistenceOfPathWithGivenSumTest {
    ExistenceOfPathWithGivenSum e = new ExistenceOfPathWithGivenSum();

    @Test
    public void testHasPathWithGivenSum() throws Exception {
        ...
        Assert.assertEquals(e.hasPathWithGivenSum(root, 10), true);
        Assert.assertEquals(e.hasPathWithGivenSum(root , 65) , false);
        Assert.assertEquals(e.hasPathWithGivenSum(null , 10) , false);
    }
}