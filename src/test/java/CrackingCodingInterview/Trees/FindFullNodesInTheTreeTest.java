 ...
 */
public class FindFullNodesInTheTreeTest {

    FindFullNodesInTheTree f = new FindFullNodesInTheTree();

    @Test
    public void findTheNumberOfFullNodes() {
        ...
        Assert.assertEquals(f.findTheFullNodesInTree(root), 2);
