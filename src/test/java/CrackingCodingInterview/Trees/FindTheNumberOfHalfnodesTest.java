 ...
 */
public class FindTheNumberOfHalfnodesTest {
    FindTheNumberOfHalfnodes f = new FindTheNumberOfHalfnodes();

    @Test
    public void findTheNumberOfHalfNodes() {
        ...
        Assert.assertEquals(f.findTheNumberOfHalfNodes(root), 4);
